...
# Classroom [![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.0-4baaaa.svg)](code_of_conduct.md)
...
* #### How to Contribute?
    ...
    Check [Contributing.md](https://github.com/OpenCodeyard/classroom/blob/dev/CONTRIBUTING.md) for guidelines on contributing to this repo.
